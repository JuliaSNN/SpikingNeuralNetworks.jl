...
function plasticity!(c::PT, param::mySTDP, dt::Float32, T::Time) where {PT <: AbstractSparseSynapse, mySTDP <: STDPAbstractParameter}
...
export STDPParameter, STDPVariables, plasticityvariables, plasticity!, STDPMexicanHat, STDPReverseMexicanHat, STDPAntiHebbianAsymmetric, STDPHebbianAsymmetric
