...
Zerlaut2019_network = (
    ...
    spatial = (
        type = :gaussian,
        σs = (; E = (200um, 200um), I = (100um, 100um)),
        ϵ = 0.4f0,
        grid_size = Float32.([1mm, 1mm]),  # Size of the grid
    ),
    turnover = (rate = 20Hz, fraction = 0.1f0, τpre = 1s, τpost = 1s, μ = 2.0f0),
...
function network(config)
    ...
    L, W, P = SNN.compute_connections(
        :E,
        :E,
        points;
        spatial = config.spatial,
        conn = config.connections.E_to_E,
    )
    ...
    synapses = (
        ...
        I_to_E = SNN.SpikingSynapse(
            ...
            E,
            :gaba,
            conn = connections.I_to_E,
            name = "I_to_E",
        ),
        I_to_I = SNN.SpikingSynapse(
            I,
            I,
            :gaba,
            conn = connections.I_to_I,
            name = "I_to_I",
        ),
    )
...
SNN.firing_rate(model.pop.E, 0:20ms:20s, time_average = true)[1] |>
x->histogram(
    x,
    ylabel = "Neurons",
