...
# save_model(; path, model, name = "AdEx_network", info = info, config = info/home/user/mnt/zeus/User_folders/aquaresi/network_models/src/SpikingNeuralNetworks.jl/examples/AdEx_network.jl)
