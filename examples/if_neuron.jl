...
E = SNN.IF(; N = 1)
r = 50Hz * 300
stim1 = SNN.PoissonStimulus(E, :ge, param = r, μ = 1.f0, neurons=:ALL)
...
plot(SNN.vecplot(E, :v, r = 0.9s:1ms:10s),
    SNN.vecplot(E, [:ge,:gi], r = 0.9s:1ms:10s), layout=(2,1), size=(800, 600))
